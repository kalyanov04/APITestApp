...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Alex", "kalyan", "asd", "ads", "asd", "ad", "33263", "-31.8129", "62.5342", "(254)954-1289", "demarco.info", "Keebler LLC", "User-centric fault-tolerant solution", "revolutionize end-to-end systems", null)]
        public virtual void AddNewUser(string name, string username, string email, string street, string suite, string city, string zipcode, string lat, string lng, string phone, string website, string cname, string catchPhrase, string bs, string[] exampleTags)
        {
...
#line 6
 testRunner.When(string.Format("I call POST method with body {0} and {1} and {2} and {3} and {4} and {5} and {6} " +
                        "and {7} and {8} and {9} and {10} and {11} and {12} and {13}", name, username, email, street, suite, city, zipcode, lat, lng, phone, website, cname, catchPhrase, bs), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 7
