...
#line hidden
        ...
        public virtual void DeleteUser(string id, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Delete user", null, @__tags);
#line 4
...
#line 6
 testRunner.When(string.Format("I call DELETE method using {0}", id), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
#line 7
